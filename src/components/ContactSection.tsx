...
export function ContactSection() {
  return (
    <>
      ...
      <div className="glass-card mx-auto mt-16 max-w-3xl space-y-4 rounded-[2rem] rounded-tr-[1rem] rounded-bl-[1rem] border border-neutral-200/80 bg-white p-6 shadow-lg dark:border-white/10 dark:bg-[#101012] md:p-8">
